...
// class BottomDragge extends StatelessWidget {
//   const BottomDragge({super.key});
...
class _bd extends State<bd> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('可拖动底部抽屉')),
        body: Stack(
          children: [
            Center(child: Text('主内容区域')),
